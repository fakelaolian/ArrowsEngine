...
ARSAPI ARS_CREATE_FRAMEBUFFER ARSCREATEFRAMEBUFFER;
...
ARSAPI ARS_OPENGL_GET_CURRENT_CONTEXT ARSOPENGLGETCURRENTCONTEXT;
#define ArsGetCurrentContext_GL ARSOPENGLGETCURRENTCONTEXT
typedef void (*ARS_OPENGL_MAKE_CONTEXT_CURRENT)(ArsWindow);
ARSAPI ARS_OPENGL_MAKE_CONTEXT_CURRENT ARSOPENGLMAKECONTEXTCURRENT;
...
ARSAPI ARS_WINDOW_SET_RESIZE_CALLBACK ARSWINDOWSETRESIZECALLBACK;
