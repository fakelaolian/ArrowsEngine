...
void init(struct android_app* app)
{
    ...
    // - Android: The TTF files have to be placed into the assets/ directory (android/app/source/main/assets), we use our GetAssetData() helper to retrieve them.
...
// Helper to retrieve data placed into the assets/ directory (android/app/source/main/assets)
